...
\begin{document}
    ...
    \noindent\textbf{\hyperlink{resp:ex9}{\hypertarget{quest:ex9}{Exercício 9}}}: Suponha que uma população humana com quantidade de indivíduos $P(t)$ viva em um ambiente qualquer.
    \begin{enumerate}[label=\alph*)]
    ...
    \noindent\textbf{\hyperlink{resp:ex10}{\hypertarget{quest:ex10}{Exercício 10}}} (Zill - Seção 1.3, Exercícios 10-12):
    \begin{enumerate}[label=\alph*)]
    ...
    \noindent\textbf{\hyperlink{resp:ex11}{\hypertarget{quest:ex11}{Exercício 11}}} (Zill - Seção 1.3, Exercícios 15 e 16):
    \begin{enumerate}[label=\alph*)]
    ...
    \noindent\textbf{\hyperlink{resp:ex12}{\hypertarget{quest:ex12}{Exercício 12}}} (Zill - Seção 1.3, Exercício 21): Um pequeno foguete de um estágio é lançado verticalmente. Uma vez lançado, o foguete consome seu combustível e assim sua massa total $m(t)$ varia com o tempo $t > 0$. Se assumirmos que a direção positiva é para cima, a resistência do ar é proporcional à velocidade instantânea $v$ do foguete e $R$ é um empurrão para cima ou força gerada pelo sistema de propulsão, construa um modelo matemático para a velocidade $v(t)$ do foguete. Use a formulação da quantidade de movimento linear da Segunda Lei de Newton, isto é, $F = \dfrac{d}{dt}(mv)$, onde $F$ é a força resultante sobre o foguete.
    \vspace{0.5cm}

    \noindent\textbf{\hyperlink{resp:ex13}{\hypertarget{quest:ex13}{Exercício 13}}} (Zill - Seção 1.3, Exercício 22): No \hyperlink{quest:ex14}{Exercício 14}, a massa $m(t)$ é a soma de três diferentes massas: $m(t) = m_p + m_v + m_f(t)$, onde $m_p$ é a massa constante de carga, $m_v$ é a massa constante do veículo e $m_f(t)$ é a quantidade variável de combustível.
    \begin{enumerate}[label=\alph*)]
