...
\begin{document}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item Determine o maior intervalo $I$ de definição da solução do problema de valor inicial do item (b).
    \end{enumerate}
    \vspace{0.5cm}

    \noindent\textbf{\hyperlink{resp:ex9}{\hypertarget{quest:ex9}{Exercício 9}}}: Considere o PVI abaixo, em que $f:\mathbb{R}\to\mathbb{R}$ e $g:\mathbb{R}\to\mathbb{R}$:
    ...
    \noindent Determine uma solução única para o PVI em um intervalo $I=(2-h, 2+h)$, $h>0$, sabendo que $f^2(t,y) + g^2(t,y) = \cos^2(y)$ para todo $(t,y) \in \mathbb{R}^2$, e que $f, g \in C^1$ em $I$.
    \vspace{0.5cm}
    ...
    \noindent\textbf{\hyperlink{resp:ex10}{\hypertarget{quest:ex10}{Exercício 10}}}: Suponha que uma população humana com quantidade de indivíduos $P(t)$ viva em um ambiente qualquer.
    \begin{enumerate}[label=\alph*)]
    ...
    \noindent\textbf{\hyperlink{resp:ex11}{\hypertarget{quest:ex11}{Exercício 11}}} (Zill - Seção 1.3, Exercícios 10-12):
    \begin{enumerate}[label=\alph*)]
    ...
    \noindent\textbf{\hyperlink{resp:ex12}{\hypertarget{quest:ex12}{Exercício 12}}} (Zill - Seção 1.3, Exercícios 15 e 16):
    \begin{enumerate}[label=\alph*)]
    ...
    \noindent\textbf{\hyperlink{resp:ex13}{\hypertarget{quest:ex13}{Exercício 13}}} (Zill - Seção 1.3, Exercício 21): Um pequeno foguete de um estágio é lançado verticalmente. Uma vez lançado, o foguete consome seu combustível e assim sua massa total $m(t)$ varia com o tempo $t > 0$. Se assumirmos que a direção positiva é para cima, a resistência do ar é proporcional à velocidade instantânea $v$ do foguete e $R$ é um empurrão para cima ou força gerada pelo sistema de propulsão, construa um modelo matemático para a velocidade $v(t)$ do foguete. Use a formulação da quantidade de movimento linear da Segunda Lei de Newton, isto é, $F = \dfrac{d}{dt}(mv)$, onde $F$ é a força resultante sobre o foguete.
    \vspace{0.5cm}

    \noindent\textbf{\hyperlink{resp:ex14}{\hypertarget{quest:ex14}{Exercício 14 }}} (Zill - Seção 1.3, Exercício 22): No \hyperlink{quest:ex14}{Exercício 14}, a massa $m(t)$ é a soma de três diferentes massas: $m(t) = m_p + m_v + m_f(t)$, onde $m_p$ é a massa constante de carga, $m_v$ é a massa constante do veículo e $m_f(t)$ é a quantidade variável de combustível.
    \begin{enumerate}[label=\alph*)]
    ...
    \chapter*{Resolução dos Exercícios}
        ...
        \noindent Como tanto $f$ quanto $g$ assumem apenas valores reais, a única maneira de a soma de dois quadrados ser igual a $0$ é se ambos os quadrados forem iguais a $0$. Dessa forma, temos que $f(t, \pi/2)=g(t, \pi/2)=0$ para todo $t \in \mathbb{R}$. Então, se tomarmos arbitrariamente a solução $y(t)=\dfrac{\pi}{2}$ para todo $t \in \mathbb{R}$, temos
        \[\begin{cases}\frac{dy}{dt} = f(t, y) + g(t, y) = f\left(t, \frac{\pi}{2}\right) + g\left(t, \frac{\pi}{2}\right) = 0+0 = 0\\
        y(2) = \frac{\pi}{2}
        \end{cases}\]
        \noindent O que confirma que $y(t)=\dfrac{\pi}{2}$ é solução do PVI dado no intervalo $I=(2-h,2+h)$, $h>0$. Ademais, como $f, g \in C^1$, $(f+g)\in C^1$ em $I$, condição que satisfaz o T.E.U e garante a unicidade da solução encontrada.
        \end{tcolorbox}
        ...
        \noindent\textcolor{blue}{\textbf{Item a)}} O sistema descrito no enunciado é dado conforme a figura a seguir:
            ...
            \definecolor{watercol}{RGB}{185, 230, 250} 
            \definecolor{textred}{RGB}{220, 0, 0}    
            ...
            \fill[watercol] (-1,2.8) rectangle (0,3.5);
        ...
        \begin{tcolorbox}[enhanced, breakable, colback=blue!1!white,colframe=blue!75!black,title=\textbf{\hyperlink{quest:ex13}{\hypertarget{resp:ex13}{Exercício 13}}}]
            ...
            \begin{tikzpicture}[>=stealth]
                ...
                \draw[smooth] (-0.3, -1.5) -- (-0.9, -2) -- (-0.3, -0.5) -- cycle;
                \draw[smooth] (0.3, -1.5) -- (0.9, -2) -- (0.3, -0.5) -- cycle;
                \draw[smooth] (-0.3, -1.5) rectangle (0.3, 1.5);
