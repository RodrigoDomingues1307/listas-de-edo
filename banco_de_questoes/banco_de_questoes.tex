...
\begin{resolucao}
    ...
    Assim, tomamos $y_1=\cos(\sqrt{7}t)$, $y_2=\sin(\sqrt{7}t)$ e $y_h(x)=c_1\cos(\sqrt{7}t)+c_2\sin(\sqrt{7}t)$.
    ...
    \[ y_p(x)=\cos(\sqrt{7}t)\int\frac{\sum_{k=3}^{n}e^{3kt}(-\sin(\sqrt{7}t))}{\sqrt{7}}dt+\sin(\sqrt{7}t)\int\frac{\sum_{k=3}^{n}e^{3kt}\cos(\sqrt{7}t)}{\sqrt{7}}dt\]
